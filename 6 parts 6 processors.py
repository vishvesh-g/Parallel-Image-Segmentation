...
def merging():
    ...
    im5 = Image.open('q4.png')
    im6 = Image.open('q5.png')

    
    get_concat_v_cut(im1, im4).save('1.png')
    get_concat_v_cut(im2, im5).save('2.png')
    get_concat_v_cut(im3, im6).save('3.png')

    im1 = Image.open('1.png')
    im2 = Image.open('2.png')
    
    get_concat_h_cut(im1, im2).save('x.png')

    im1 = Image.open('x.png')
    im2 = Image.open('3.png')

    get_concat_h_cut(im1, im2).save('final seg (6-6).png')

    
def slicing():
    tiles = image_slicer.slice('im.png', 6, save=False)
    print('Slicing')
...
if __name__=='__main__':
    ...
    process5=Process(target=ic, args=([image[4],4]))
    process6=Process(target=ic, args=([image[5],5]))
